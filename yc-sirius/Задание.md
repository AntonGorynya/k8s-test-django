...
# Ресурсы
## Домен
Выделен домен [edu-goofy-allen.sirius-k8s.dvmn.org.](edu-goofy-allen.sirius-k8s.dvmn.org.) Запросы обрабатывает Yandex Application Load Balancer.
